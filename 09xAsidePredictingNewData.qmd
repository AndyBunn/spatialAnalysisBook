...
## Packages
We'll use `tidyverse`[@R-tidyverse] for data wrangling.
...
::: {.callout-note}
See the [Understanding Methods and Generics in R aside](02xAsideMethodsAndGenerics.html) if the idea of a generic `predict` function dispatching to `predict.lm` is unclear.
:::
