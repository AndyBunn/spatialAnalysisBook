...
Now we have distances in kilometers. Bellingham to Glacier is about `r round(as.numeric(D_proj[1,2]) / 1000)` km. Bellingham to Anacortes is about `r round(as.numeric(D_proj[1,4]) / 1000)` km. These match what you'd get from a map.
