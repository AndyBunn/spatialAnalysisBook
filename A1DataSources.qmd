...
Two California datasets appear in the spatial data crash course and the interpolation chapters: ozone monitoring station records and weather station precipitation records. Both come from the `rspat` package by Robert Hijmans, which bundles teaching datasets for the [rspatial.org](https://rspatial.org) tutorials.
