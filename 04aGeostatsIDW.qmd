...
::: {.callout-note}
If you need a refresher in `dist()`, work through the [Distance Matrices aside](02xAsideDistanceMatrices.html).
:::
...
For a full treatment of the null model and how to interpret these skill scores, see the [Model Skill and Cross Validation aside](04xAsideModelSkill.html).
