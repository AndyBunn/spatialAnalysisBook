...
::: {.callout-note}
If you want a refresher on how to fit an OLS model and then apply it to new data with `predict`, see the [Predicting New Data aside](05xAsidePredictingNewData.html). That pattern is the foundation of the RK workflow.
:::
