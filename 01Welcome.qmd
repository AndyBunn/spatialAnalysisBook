...
The book is built around R, so you'll need a working R installation. You should be reasonably up to date on your versions of R, RStudio, and relevant packages. If you're not sure, run:

``` r
update.packages()
```

Do it now, and anytime it occurs to you.
