...
2.  **Download the `data/` folder**\
    ...
    You can [download the data directly](https://github.com/AndyBunn/spatialAnalysisBook/releases/download/data-latest/data.zip) from the GitHub [repo](https://github.com/AndyBunn/spatialAnalysisBook):
