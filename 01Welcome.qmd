...
One more thing about the code. We mostly use **tidyverse** syntax: `dplyr` for wrangling, `ggplot2` for plots, the pipe to chain it together. If that style is new to you, don't let it slow you down. There are loads and loads of free resources out there for learning it. The place to start is tidyverse.org^[<https://www.tidyverse.org/>], and from there R for Data Science [@wickham2023r4ds] is the canonical free book.
