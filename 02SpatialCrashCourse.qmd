...
We'll use four packages in this chapter. `tidyverse` [@R-tidyverse] for general data wrangling, `sf` [@R-sf] for vector spatial data, `terra` [@R-terra], and `tidyterra` [@R-tidyterra] for rasters. You'll see these same packages throughout the book. Full citations are in the [References](12References.html) chapter at the back.
