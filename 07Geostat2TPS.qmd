...
The `fields`[@R-fields] package is the main package we'll use for thin-plate splines. We'll lean on our usual spatial toolkit as well: `tidyverse`[@R-tidyverse], `gstat`[@R-gstat], `sf`[@R-sf], `terra`[@R-terra], and `tidyterra`[@R-tidyterra].
