...
TPS beats the null. The skill score here (`r round(1 - (rmse / rmseNULL),3)`) usually lands around 0.35-0.45 depending on the random split. Compare that to IDW from the last module, where the skill score was around 0.22-0.25. TPS is doing better, though not dramatically. For a full treatment of how to interpret these skill scores, see the [Model Skill and Cross Validation aside](06xAsideModelSkill.html).
