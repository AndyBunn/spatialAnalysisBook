...
`meuse2` has `r nrow(meuse2)` point measurements and `meuse.grid2` has `r nrow(meuse.grid2)` grid cells. See the [appendix](A1MeuseData.qmd) for full variable descriptions.
