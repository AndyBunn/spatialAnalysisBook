...
The practical upshot follows the [KISS principle](https://en.wikipedia.org/wiki/KISS_principle): use OLS when its assumptions are met, reach for GLS when they are not.
